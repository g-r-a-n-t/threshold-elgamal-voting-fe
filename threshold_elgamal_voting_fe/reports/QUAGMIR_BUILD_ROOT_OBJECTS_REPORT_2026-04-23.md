...
```text
Wrote /tmp/threshold-elgamal-voting-fe-master-yul-build/ThresholdElection.bin
Wrote /tmp/threshold-elgamal-voting-fe-master-yul-build/ThresholdElection.runtime.bin
Wrote /tmp/threshold-elgamal-voting-fe-master-yul-build/ThresholdElection.abi.json
```
