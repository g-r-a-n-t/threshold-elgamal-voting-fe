...
Add this test to `ingots/threshold_elgamal_fe_tests/src/lib.fe`:
...
timeout 60s /home/grant/workshop/fe-quagmir/target/debug/fe --color never test ingots/threshold_elgamal_fe_tests --filter test_contract_rejects_invalid_ballot_point
```
...
```sh
timeout 60s /home/grant/workshop/fe-quagmir/target/debug/fe --color never test ingots/threshold_elgamal_fe_tests --filter test_invalid_g1_point_is_rejected
```
...
```sh
timeout 60s /home/grant/workshop/fe-quagmir/target/debug/fe --color never test ingots/threshold_elgamal_fe_tests --filter test_add_ciphertexts_with_identity_preserves_ballot
```
